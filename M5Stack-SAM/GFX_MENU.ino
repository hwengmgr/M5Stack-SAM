// This disabled section prints the programmers name Tom Such on the menu screen. Line 66 is also disabled in connection with this section. 
// To re-enable this section, you need to also re-enable line 66 below. 
